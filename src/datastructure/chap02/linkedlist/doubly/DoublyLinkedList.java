...
public class DoublyLinkedList {
    ...
    // SentinelNode()는 첫번째와 마지막만본다 왜냐면 첫번째와 마지막만봐도 전부찾을수있기때문
    ...
    public void add(int data) {
        ...
        // 새로운 노드가 맨 처음 위치에 삽입되는 경우
            ...
            newNode.setNextNode(sentinel.getFirstNode()); // sentinel이 알고있으니까
            sentinel.setFirstNode(newNode);
        }
