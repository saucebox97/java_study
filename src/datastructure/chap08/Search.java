...
public class Search {
    ...
    public static int binarySearch(int[] arr, int target) {
        ...
        while (left <= right) {
            ...
            // 찾고자 하는 값이 mid 값과 일치할 경우 탐색 종료
            if (arr[mid] == target) { // mid랑 값비교
                return mid;
    ...
    public static void main(String[] args) {
        ...
        int target = 53; // Linear Search 는 정렬안됀곳에서도 찾을 수 있다
        ...
        System.out.println(Arrays.binarySearch(arr, target)); // 이진 탐색
    }
}
