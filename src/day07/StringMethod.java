...
public class StringMethod {
    ...
    public static void main(String[] args) {
        ...
        // : 문자열의 특정 범위를 추출
        String ss1 = str.substring(1, 5); // 1번이상 5미만 슬라이싱
        ...
        int idx1 = str.indexOf("l");// 앞에서부터 탐색에서 먼저발견된 l을 알려줌
        ...
        // replace(lod, new) : 문자열 내부에 old문자를 모두 탐색하여 new문자를 변수
        ...
        String ext = filePath.substring(filePath.lastIndexOf("jpg"));
        System.out.println("ext = " + ext);

        switch (ext.toLowerCase()) {
            case "jpg":case "git": case "png": case "svg":
                System.out.println("이미지 파일입니다");
                break;
            default:
                System.out.println("이미지 파일이아닙니다");
        }
