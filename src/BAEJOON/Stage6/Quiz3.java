...
public class Quiz3 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < S.length(); i++) {
            ...
            if (alphaPos[c1 - 97] != -1) continue; //char랑int랑연산하면 int c1앞에 (int)안써도됌
            alphaPos[c1 - 97] = i;
        }
        ...
        // index는 처음꺼만 연산돼기떄문에 oo는 앞에꺼만됀다

         */

        // 'b' -> 문자열에서는 0번 -> 알파벳베열 1번
...
//        alphaPos[0] = 1;
//
//        char c3 = S.charAt(1); // 'e'; = 101
//        alphaPos[4] = 2;
//
//        char c4 = S.charAt(1); // 'k';
//        alphaPos[10] = 3;
