...
public class Bank {
    ...
    // 등록된 모든 계좌 조회 기능
    void showAccounts() {
        System.out.printf("===== [%s은행] 등록계좌 (총 %s개) =====\n"
        ...
        for (int i = 0; i < this.accountCount; i++) {
            ...
            /*
                ...
                accounts[0].balance - 첫번째 계좌의 잔액정보 /accounts 는 account[]타입
                accounts[0].owner - 첫번재 계좌의 예금주 모든정보
                accounts[0].owner.name - 첫번째 계좌의 예끔주의 이름
             */
        }
    }
}
